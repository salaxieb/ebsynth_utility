            ...
            with gr.Column(variant="panel"):
                ...
                with gr.Row():
                    with gr.Tabs(elem_id="ebs_settings"):
                        with gr.TabItem(
                            "project setting", elem_id="ebs_project_setting"
                        ):
                            project_dir = gr.Textbox(label="Project directory", lines=1)
                            original_movie_path = gr.Textbox(
                                label="Original Movie Path", lines=1
                            )
                            ...
                            org_video.upload(
                                fn_upload_org_video, org_video, original_movie_path
                            )
                            gr.HTML(
                                value="<p style='margin-bottom: 1.2em'>\
                        ...
                        with gr.TabItem("configuration", elem_id="ebs_configuration"):
                            with gr.Tabs(elem_id="ebs_configuration_tab"):
                                with gr.TabItem(
                                    label="stage 1", elem_id="ebs_configuration_tab1"
                                ):
                                    with gr.Row():
                                    ...
                                    st1_masking_method_index = gr.Radio(
                                        label="Masking Method",
                                        choices=[
                                            "transparent-background",
                                            "clipseg",
                                            "transparent-background AND clipseg",
                                        ],
                                    ...
                                    with gr.Accordion(
                                        label="transparent-background options"
                                    ):
                                        st1_mask_threshold = gr.Slider(
                                            minimum=0.0,
                                            maximum=1.0,
                                            step=0.01,
                                        ...
                                        gr.HTML(
                                            value='<p style=\'margin-bottom: 0.7em\'>\
                                                configuration for \
                                                <font color="blue"><a href="https://pypi.org/project/transparent-background">[transparent-background]</a></font>\
                                                </p>'
                                        )
                                        tb_use_fast_mode = gr.Checkbox(
                                            label="Use Fast Mode(It will be faster, but the quality of the mask will be lower.)",
                                            value=False,
                                        )
                                        tb_use_jit = gr.Checkbox(
                                            label="Use Jit", value=False
                                        )

                                    with gr.Accordion(label="clipseg options"):
                                        clipseg_mask_prompt = gr.Textbox(
                                            label="Mask Target (e.g., girl, cats)",
                                            lines=1,
                                        )
                                        clipseg_exclude_prompt = gr.Textbox(
                                            label="Exclude Target (e.g., finger, book)",
                                            lines=1,
                                        )
                                        clipseg_mask_threshold = gr.Slider(
                                            minimum=0.0,
                                            maximum=1.0,
                                            step=0.01,
                                            label="Mask Threshold",
                                        ...
                                        clipseg_mask_blur_size = gr.Slider(
                                            minimum=0,
                                            maximum=150,
                                            step=1,
                                            label="Mask Blur Kernel Size(MedianBlur)",
                                            value=11,
                                        )
                                        clipseg_mask_blur_size2 = gr.Slider(
                                            minimum=0,
                                            maximum=150,
                                            step=1,
                                            label="Mask Blur Kernel Size(GaussianBlur)",
                                            value=11,
                                        )

                                with gr.TabItem(
                                    label="stage 2", elem_id="ebs_configuration_tab2"
                                ):
                                    key_min_gap = gr.Slider(
                                        minimum=0,
                                        maximum=500,
                                        step=1,
                                    ...
                                    key_th = gr.Slider(
                                        ...
                                        maximum=100.0,
                                        step=0.1,
                                        label="Threshold of delta frame edge",
                                        value=8.5,
                                    )
                                ...
                                with gr.TabItem(
                                    ...
                                    color_matcher_method = gr.Radio(
                                        label="Color Transfer Method",
                                        choices=[
                                            "default",
                                            "hm",
                                            "reinhard",
                                    ...
                                    color_matcher_ref_type = gr.Radio(
                                        label="Color Matcher Ref Image Type",
                                        choices=[
                                            "original video frame",
                                            "first frame of img2img result",
                                        ],
                                        value="original video frame",
                                        type="index",
                                    )
                                    gr.HTML(
                                        value="<p style='margin-bottom: 0.7em'>\
                                    ...
                                    color_matcher_ref_image = gr.Image(
                                        label="Color Matcher Ref Image",
                                        source="upload",
                                        mirror_webcam=False,
                                        type="pil",
                                    )
                                    st3_5_use_mask = gr.Checkbox(
                                        label="Apply mask to the result", value=True
                                    )
                                    st3_5_use_mask_ref = gr.Checkbox(
                                        label="Apply mask to the Ref Image", value=False
                                    )
                                    st3_5_use_mask_org = gr.Checkbox(
                                        label="Apply mask to original image",
                                        value=False,
                                    )
                                    # st3_5_number_of_itr = gr.Slider(minimum=1, maximum=10, step=1, label='Number of iterations', value=1)

                                with gr.TabItem(
                                    label="stage 7", elem_id="ebs_configuration_tab7"
                                ):
                                    blend_rate = gr.Slider(
                                        minimum=0.0,
                                        maximum=1.0,
                                        step=0.01,
                                        label="Crossfade blend rate",
                                        value=1.0,
                                    )
                                    export_type = gr.Dropdown(
                                        choices=["mp4", "webm", "gif", "rawvideo"],
                                        value="mp4",
                                        label="Export type",
                                    )

                                with gr.TabItem(
                                    label="stage 8", elem_id="ebs_configuration_tab8"
                                ):
                                    bg_src = gr.Textbox(
                                        label="Background source(mp4 or directory containing images)",
                                        lines=1,
                                    )
                                    bg_type = gr.Dropdown(
                                        choices=["Fit video length", "Loop"],
                                        value="Fit video length",
                                        label="Background type",
                                    )
                                    mask_blur_size = gr.Slider(
                                        minimum=0,
                                        maximum=150,
                                        step=1,
                                        label="Mask Blur Kernel Size",
                                        value=5,
                                    )
                                    ...
                                    fg_transparency = gr.Slider(
                                        minimum=0.0,
                                        maximum=1.0,
                                        step=0.01,
                                        label="Foreground Transparency",
                                        value=0.0,
                                    )

                                with gr.TabItem(
                                    label="etc", elem_id="ebs_configuration_tab_etc"
                                ):
                                    mask_mode = gr.Dropdown(
                                        choices=["Normal", "Invert", "None"],
                                        value="Normal",
                                        label="Mask Mode",
                                    )
                            ...
                            with gr.Column(scale=2):
                                ...
                                gr.HTML(
                                    value="<p style='margin-bottom: 0.7em'>\
                                                ...
                                                <b>stage 0_5</b> <br>\
                                                    Decrease video fps to look more natural. <br><br>\
                                                <b>stage 1</b> <br>\
                                                ...
                                                <b>stage 6</b> <br>\
                                                    ...
                                                    If "
                                    "out-*"
                                    ' directory already exists in the Project directory, delete it manually before executing.<br>\
                                                    If multiple .ebs files are generated, run them all.<br><br>\
                                                <b>stage 7</b> <br>\
                                                    Crossfade front and back of image.<br><br>\
                                                <b>stage 7_5</b> <br>\
                                                    Concatenate video with different configurations onto the concatenated video.<br><br>\
                                                <b>stage 8</b> <br>\
